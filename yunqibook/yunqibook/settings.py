...
# Scrapy settings for yunqibook project
#
...
SPIDER_MODULES = ['yunqibook.spiders']
NEWSPIDER_MODULE = 'yunqibook.spiders'
...
#SPIDER_MIDDLEWARES = {
#    'yunqibook.middlewares.YunqibookSpiderMiddleware': 543,
#}
