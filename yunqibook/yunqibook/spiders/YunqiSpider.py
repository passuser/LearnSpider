...
class YunqiSpider(CrawlSpider):
    ...
    def parse_book_list(self,response):
        ...
        for book in books:
            book_image = 'http:'+book.xpath("./a/img/@src").extract_first()  
            book_name =  book.xpath("./div[@class='book_info']/h3/a/text()").extract_first()
            bookinfos = book.xpath("./div[@class='book_info']//dd")
            bookurl = book.xpath("./div[@class='book_info']/h3/a/@href").extract_first()
            ...
            List_items = YunqibookItemList(
                ...
                book_author=book_author,book_updaetime=book_updaetime,book_info=book_info,book_type=book_type,
    ...
    def parse_book_detail(self,response):
        bookdetail = response.xpath(".//div[@id='novelInfo']/table//tr")
        if bookdetail :
